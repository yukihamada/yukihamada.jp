...
> **【2026-02-24 時点のスナップショット】** 数字（210ユーザー / 3万req/日 / 月800ドルコスト）は当時のもの。現在の chatweb.ai は構成が変わっており、Lambda は削除済み、Fly.io の `chatweb-ai` 一本に移行している。最新状況は [chatweb.ai リニューアル](/blog/2026-04-01-chatweb-renewal) を参照。
